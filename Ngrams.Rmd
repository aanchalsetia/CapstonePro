...
## Setup
```{r}
### Coursera's Data Science Capstone 
### Generates the required ngram data files used to predict ngrams.
...
```{r}
dir.create("ngram_data", showWarnings = FALSE)
saveRDS(bi_words, "./ngram_data/bi_words_top.rds")
saveRDS(tri_words, "./ngram_data/tri_words_top.rds")
saveRDS(quad_words,"./ngram_data/quad_words_top.rds")
saveRDS(quint_words,"./ngram_data/quint_words_top.rds")
saveRDS(sext_words,"./ngram_data/sext_words_top.rds")
```